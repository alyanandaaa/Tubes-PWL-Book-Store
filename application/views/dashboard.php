  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url('assets/img/2.jpg') ?>" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="<?php echo base_url('assets/img/4.jpg') ?>" alt="Third slide">
        </div>
      </div>
    ...
    <span class="card-title text-black" > <?php if ($brg->stok >= 10)
         {
            ...
            echo 'Stock:
            <span class="badge badge-danger">Stock Habis</span></strong>';
         }
         ?></span><br><br>
