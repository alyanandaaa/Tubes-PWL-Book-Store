...
<html>
    ...
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
				<?php $no=1; foreach($barang as $brg){?>
				     <tr>
				          <td><?php echo $no++ ?></td>
                  <td><?php echo $brg->name_stck ?></td>
                  <td><?php echo $brg->kategori ?></td>         
                  <td>Rp <?php echo number_format($brg->price)  ?></td>
                  <td><?php echo $brg->stock ?></td>
                   <td><?php echo $brg->sinopsis ?></td>
								<td>
									<button class="btn btn-warning" onclick="edit_book(<?php echo $barang->id_stck;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="delete_book(<?php echo $barang->id_stck;?>)"><i class="glyphicon glyphicon-remove"></i></button>
                  </center>
  ...
  $(document).ready( function () {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('index.php/data/book_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/data/book_update')?>";
      }
